...
def fixed_parameters(obj,destination_path_cube="/home/mainak/Downloads/Outflow_paper1/VIMOS"):
...
def light_weighted_centroid(obj,destination_path_cube="/home/mainak/Downloads/Outflow_paper1/VIMOS"):
...
def plot_coupled_kin(obj,wo_wave,data,error,z,popt_coupled_fit,destination_path_cube="/home/mainak/Downloads/VIMOS_plots"):
...
def agn_loc(obj,destination_path_cube="/home/mainak/Downloads/Outflow_paper1/VIMOS"):
...
def aperture_size_VIMOS(obj,destination_path_cube="/home/mainak/Downloads/Outflow_paper1/VIMOS"):
    hdu = fits.open('%s/Flux Maps/%s/17_arcsec_subcube_par_%s.fits'%(destination_path_cube,obj,obj))
    (OIII_nr,OIII_br,Hb1_blr_br,Hb2_blr_br) = (hdu[2].data,hdu[3].data,hdu[5].data,hdu[6].data)
    box_size = np.shape(OIII_nr)[0]
    return box_size
    
def moffat_centers(obj,destination_path_cube="/home/mainak/Downloads/Outflow_paper1/VIMOS"):
    hdu = fits.open('%s/%s/17_arcsec_moffat_table_%s.fits'%(destination_path_cube,obj,obj))
    central_tab = hdu[1].data
    central_columns = hdu[1].header
    (Hb_x,Hb_y) = (central_tab.field('x0_Hb_Blr')[0],central_tab.field('y0_Hb_Blr')[0])
