...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 10 16:35:43 2020
...
def plot_coupled_kin(obj,wo_wave,data,error,z,popt_coupled_fit):
   ...
   # fig.set_size_inches(10, 10)
    ...
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + nlr_gauss_coupled(wo_wave[select],amp_Ha_core,amp_NII6583_core,amp_SII6716_core,amp_SII6731_core,vel_core,vel_sigma_core),label='Ha+[NII]+[SII] core',color='purple')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + nlr_gauss_coupled(wo_wave[select],amp_Ha_wing,amp_NII6583_wing,amp_SII6716_wing,amp_SII6731_wing,vel_wing,vel_sigma_wing),label='Ha+[NII]+[SII] wing',color='brown')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + blr_gauss(wo_wave[select],amp_Ha_blr1,vel_blr1,vel_sigma_blr1),'m-',label='blr_1')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + blr_gauss(wo_wave[select],amp_Ha_blr2,vel_blr2,vel_sigma_blr2),'g-',label='blr_2')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + blr_gauss(wo_wave[select],amp_Ha_blr3,vel_blr3,vel_sigma_blr3),'b-',label='blr_3')
...
def plot_decoupled_kin(obj,wo_wave,data,error,z,popt_decoupled_fit):
    ...
    plt.plot(wo_wave[select],fit,'r-',label='fit')
    plt.plot(wo_wave[select],residual,label='residual')  
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + nlr_gauss_decoupled(wo_wave[select],amp_Ha_core,amp_NII6583_core,vel_Ha_core,vel_sigma_Ha_core),label='Ha + [NII] core',color='purple')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + SII_doublet_gauss(wo_wave[select],amp_SII6716_core,amp_SII6731_core,vel_SII6731_core,vel_sigma_SII6731_core),label='SII core',color='orange')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + nlr_gauss_decoupled(wo_wave[select],amp_Ha_wing,amp_NII6583_wing,vel_Ha_wing,vel_sigma_Ha_wing),label='Ha + [NII] wing',color='brown')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + SII_doublet_gauss(wo_wave[select],amp_SII6716_wing,amp_SII6731_wing,vel_SII6731_wing,vel_sigma_SII6731_wing),label='SII wing',color='cyan')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + blr_gauss(wo_wave[select],amp_Ha_blr1,vel_blr1,vel_sigma_blr1),'m-',label='blr_1')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + blr_gauss(wo_wave[select],amp_Ha_blr2,vel_blr2,vel_sigma_blr2),'g-',label='blr_2')
    plt.plot(wo_wave[select],continuum(wo_wave[select],m,c) + blr_gauss(wo_wave[select],amp_Ha_blr3,vel_blr3,vel_sigma_blr3),'b-',label='blr_3')
